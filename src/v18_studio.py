...
# v18: proof-first premium compositor. No storyboard.b64/Pillow hero dependency.
# Browser-quality UI proof fills frame; kinetic typography and depth are generated by ffmpeg layers.
fc="""
...
fade=t=in:st=0:d=.18,fade=t=out:st={fadeout:.3f}:d=.25[v]
""".replace('{fadeout}',str(max(0,D-.25))).replace('\n','')
