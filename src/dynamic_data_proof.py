...
def dynamic_data_filter(scene_index: int, start_at: float) -> str:
    """Animate cursor click, selected cell, row reduction, countdown and linked chart."""
    ...
    parts = [
        ...
        # Cursor visibly travels into the first cell before selection/click.
    ...
    parts.extend([
        ...
        # Formula/result cell links the table change to the chart update.
