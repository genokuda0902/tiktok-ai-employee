...
(10,'motion_graphics','applications','motion_graphics',4.0,'要約・メール・可視化・アイデア・自動化'),
(11,'cta','save_follow','premium_robot',4.0,'保存して明日使う'),
(12,'motion_graphics','next','device_scene',2.0,'次回 ChatGPTでスライド資料'),
(13,'character','brand','premium_robot',2.0,'AI時短ラボ'),
(14,'human','message','cinematic_city',2.0,'AIで働き方はもっと自由になる'),
(15,'motion_graphics','icons','motion_graphics',1.0,'時短・効率化・豊かな生活'),
(16,'character','finale','premium_robot',1.0,'また次の動画で')]

plan={
 'version':'v19',
 'target':'premium human-edited TikTok / high-quality video generation app output',
 'rule':'never stretch one proof screen into a whole video',
 ...
 'hard_reject':['single-screen-dominant','slide-deck-feel','low-resolution-crop','static-scene-over-2.2s','missing-cinematic-assets','missing-operation-proof']
}
Path('output').mkdir(exist_ok=True)
# canonical filename consumed by strict v19 QA
