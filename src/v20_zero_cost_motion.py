...
# Split the approved 2x3 storyboard into six sources.
W,H=600,1066
for i,(r,c) in enumerate([(0,0),(0,1),(1,0),(1,1),(2,0),(2,1)],1):
    x=c*(W//2); y=r*(H//3); w=W//2; h=H//3
    subprocess.run(['magick',str(STORY),'-crop',f'{w}x{h}+{x}+{y}','+repage','-resize','1080x1920^','-gravity','center','-extent','1080x1920',str(SCENES/f's{i}.jpg')],check=True)
durs=[4,4,5,5,5,6]; clips=[]
